    ...
    return (
        <div className='gpt3__features section__padding' id='features'>
            ...
            <div className='gpt3__feature-container'>
                ...
                <Feature title='Really boy low county'
                    text='Really boy law county she unable her sister. Feet you off its like like six. Among sex are leave law built now. In built table in an rapi ' />
            </div>
